...
## [6.0.0](https://github.com/ubq-testing/ubiquibot-kernel/compare/v5.0.0...v6.0.0) (2025-11-12)
...
* actions sdk ([c4160c6](https://github.com/ubq-testing/ubiquibot-kernel/commit/c4160c6d095a0354f59666c5f8e90cfceaab1a4c))
* add app id and bot user id ([d292f5a](https://github.com/ubq-testing/ubiquibot-kernel/commit/d292f5abf93301aaee0d508a0166d891ac36fd18))
* add collectLinkedIssues utility and enhance author mapping logic ([9ae5ea7](https://github.com/ubq-testing/ubiquibot-kernel/commit/9ae5ea74ffbc09f9417d494e0d3bd626a89022dd))
* add environment variable to configuration ([6d443e7](https://github.com/ubq-testing/ubiquibot-kernel/commit/6d443e75a993000da52a552a6d7af25c74cfe978))
* add environment variable to configuration ([c3dc29d](https://github.com/ubq-testing/ubiquibot-kernel/commit/c3dc29de2c3cf00c3d5e369f260974181f8ee46c))
* add signature to action plugins ([a682ce0](https://github.com/ubq-testing/ubiquibot-kernel/commit/a682ce0d64438bc82a60eaba251a4bc0b8094c49))
* add tests ([2be91f6](https://github.com/ubq-testing/ubiquibot-kernel/commit/2be91f648bb2c98e73549e5a7ed7fd5c5025098d))
* added branch deployment ([51f1276](https://github.com/ubq-testing/ubiquibot-kernel/commit/51f1276aac4a4c382876a83e597d4610bcbbb65b))
* added manifest to hello-world-plugin.ts ([d93b5c3](https://github.com/ubq-testing/ubiquibot-kernel/commit/d93b5c33ca0913a09a78034c7de7100f232a46c6))
* added ref on manifest.json retrieval for workers ([bd1f58f](https://github.com/ubq-testing/ubiquibot-kernel/commit/bd1f58fac4fc2e591411e3696baab22cb0b247e1))
* added release-please.yml ([1ee4961](https://github.com/ubq-testing/ubiquibot-kernel/commit/1ee4961c3b05ed9b8b69520cc18aef9d6d54c73d))
* added tests for ref manifest fetching ([49bef29](https://github.com/ubq-testing/ubiquibot-kernel/commit/49bef29e119de767a55edd4d6069417f4984e977))
* additional properties and required ([639e4e3](https://github.com/ubq-testing/ubiquibot-kernel/commit/639e4e39f7e45ff449596c1aaea2ad4cb214ef84))
* azure deployment ([bb72c0a](https://github.com/ubq-testing/ubiquibot-kernel/commit/bb72c0adf9da421cbe73a2a53efa31eb71140e2d))
* configuration annotations ([0c7210e](https://github.com/ubq-testing/ubiquibot-kernel/commit/0c7210e2e1865ad7a1ad1a0c6393b9c66bdff4e0))
* development config ([94e2685](https://github.com/ubq-testing/ubiquibot-kernel/commit/94e26850def80bfd770149bc364967745c58b7a0))
* enabling worker observability ([4853aa8](https://github.com/ubq-testing/ubiquibot-kernel/commit/4853aa80b824274c3fdfae1f0380ab121ba6e847))
* enhance author mapping logic and add pre-check for bot commands ([69cdc77](https://github.com/ubq-testing/ubiquibot-kernel/commit/69cdc77a21d29412e72ea01f71be2c2675048330))
* environment variables and worker logs ([89c9ad2](https://github.com/ubq-testing/ubiquibot-kernel/commit/89c9ad2228be4b07181b4214be06fea0e966c786))
* export ([f56714b](https://github.com/ubq-testing/ubiquibot-kernel/commit/f56714b24474400f82e1e53026d4cfd600549091))
* export additional config constants ([39e22fd](https://github.com/ubq-testing/ubiquibot-kernel/commit/39e22fdccdb08567773098af9776ea52b0abadfb))
* export additional config constants ([a2ca525](https://github.com/ubq-testing/ubiquibot-kernel/commit/a2ca5258e2a233b7bc54d49ee2b58ca25776dbbe))
* export context ([1f6c922](https://github.com/ubq-testing/ubiquibot-kernel/commit/1f6c922956113f9d9d131237fcd3afe19f53ff33))
* fix signature and add plugin github token ([6941ff8](https://github.com/ubq-testing/ubiquibot-kernel/commit/6941ff841db7f9a616f9e92e86f4a0dc120ea46c))
* help command manifest ([056989f](https://github.com/ubq-testing/ubiquibot-kernel/commit/056989f7f2d8be33cec71ec64dfd0f0c24ab398c))
* hono ([a8e29de](https://github.com/ubq-testing/ubiquibot-kernel/commit/a8e29dec63807c70b2eef1e3f271fed0320c6444))
* hono ([1a53d48](https://github.com/ubq-testing/ubiquibot-kernel/commit/1a53d481a751cef3b13b3945e374f6baacf5d103))
* hono ([fef7870](https://github.com/ubq-testing/ubiquibot-kernel/commit/fef7870afc5cf751e434f49cd04763ee32645e91))
* improvements ([393ca5d](https://github.com/ubq-testing/ubiquibot-kernel/commit/393ca5d5af87cdff00cdfa0418d27849f8dae965))
* initial impl ([c5b77f3](https://github.com/ubq-testing/ubiquibot-kernel/commit/c5b77f32fc1518d5bf5ed525dcc185d429b87c9d))
* interactive setup ([6916ad3](https://github.com/ubq-testing/ubiquibot-kernel/commit/6916ad3b31491ef2b8d8531a985727f04bcf67a8))
* jest typescript config ([132537c](https://github.com/ubq-testing/ubiquibot-kernel/commit/132537c6849ede075c25dd81d39b7c12f76101c1))
* make createPlugin sync function ([ff36f56](https://github.com/ubq-testing/ubiquibot-kernel/commit/ff36f5665d7661a253f20ef5598d712bbc26ac23))
* manifest commands object ([67de8cf](https://github.com/ubq-testing/ubiquibot-kernel/commit/67de8cf4dc1ff08597ed02fcd3f00a72505ab204))
* manifest is now read and cached from the target repo ([9c66d70](https://github.com/ubq-testing/ubiquibot-kernel/commit/9c66d7077cf64b6609b6d3abdaba1686b8dba775))
* map task author help requests to UbiquityOS ([cdccbe8](https://github.com/ubq-testing/ubiquibot-kernel/commit/cdccbe8b0a7d81b04fb9705fa08e2868997366cd))
* merge ([6d24748](https://github.com/ubq-testing/ubiquibot-kernel/commit/6d2474877400309adec0eec382b629f64eab6265))
* more context and tests ([e90a93d](https://github.com/ubq-testing/ubiquibot-kernel/commit/e90a93d4313703b88becd25c2918c154ae0be1fc))
* multiple commands can be handled for skip ([7b3e111](https://github.com/ubq-testing/ubiquibot-kernel/commit/7b3e11100ce055961309c1faed38f10cf14f82f6))
* payload is fetched from KV ([de80953](https://github.com/ubq-testing/ubiquibot-kernel/commit/de80953852a459d84f34ff6ef9d79b8b57dc3a71))
* plugins can describe their own event listeneners ([d0f975a](https://github.com/ubq-testing/ubiquibot-kernel/commit/d0f975af936b1dbceaae561c4ea07f9725dc87eb))
* publish package ([70561e9](https://github.com/ubq-testing/ubiquibot-kernel/commit/70561e96231320fb53c7ab3a2328b4f0f9a2fed7))
* serve manifest ([34adce1](https://github.com/ubq-testing/ubiquibot-kernel/commit/34adce187ac254db3b3cb2dfb52f044c7809c19b))
* test for skipBotEvents ([128e93e](https://github.com/ubq-testing/ubiquibot-kernel/commit/128e93efc9a28533834d009d582f62894a2a4927))
* ubiquity logger ([4053df7](https://github.com/ubq-testing/ubiquibot-kernel/commit/4053df7252759b74359bf05fdc87fd1d92be0875))
* use empty store ([af5da64](https://github.com/ubq-testing/ubiquibot-kernel/commit/af5da64136811c8a1d5766cf2e851a282f86af63))


### Bug Fixes

* action name regex ([ae277de](https://github.com/ubq-testing/ubiquibot-kernel/commit/ae277dead2575d3a1a3050f00e61748cbcc33d05))
* add error handling to plugin dispatch ([a3acebf](https://github.com/ubq-testing/ubiquibot-kernel/commit/a3acebff41da8284adaa9669f4ca987969fe506d))
* add error handling to schema decoding ([7b15aa1](https://github.com/ubq-testing/ubiquibot-kernel/commit/7b15aa133404f3e254b2bdc2e7cd347bad47067b))
* add npm token authentication ([64e1d16](https://github.com/ubq-testing/ubiquibot-kernel/commit/64e1d16fa3b92a12a21e981c5ffd08586515530b))
* add npm token authentication ([d551da3](https://github.com/ubq-testing/ubiquibot-kernel/commit/d551da3f55f4f1e09b731a47428f70ee42417cb0))
* add paginateGraphQL plugin to customOctokit ([a3e1202](https://github.com/ubq-testing/ubiquibot-kernel/commit/a3e1202beb2fd55f5ff79e33fbc4f538ff145dfb))
* bumped plugin-sdk ([a65c27a](https://github.com/ubq-testing/ubiquibot-kernel/commit/a65c27a05110e0fd11b76b51a0b64de2e458fd44))
* bumped wrangler version ([9f647ab](https://github.com/ubq-testing/ubiquibot-kernel/commit/9f647aba36cfcd15d341c37c332681d618aa5c6a))
* call plugins synchronously ([78c8460](https://github.com/ubq-testing/ubiquibot-kernel/commit/78c8460b5ebe85946aa233fbba2af8ac3a8a8018))
* call plugins synchronously ([8f386a0](https://github.com/ubq-testing/ubiquibot-kernel/commit/8f386a0ab0d76a59379477507756daba8a238008))
* change file name ([561077e](https://github.com/ubq-testing/ubiquibot-kernel/commit/561077e5713a202bfff476948d46ac2d3e1556be))
* ci ([026ed42](https://github.com/ubq-testing/ubiquibot-kernel/commit/026ed429e5ea1ca164d46a138042cb26e8f3b259))
* ci test ([199c646](https://github.com/ubq-testing/ubiquibot-kernel/commit/199c646085e13c93ea101581f6de5d157e759f60))
* command skip ([c91cce2](https://github.com/ubq-testing/ubiquibot-kernel/commit/c91cce2a29bb33656c451306db364cb2f51ea504))
* configuration files do not load asynchronously ([cf248d1](https://github.com/ubq-testing/ubiquibot-kernel/commit/cf248d178bdf6fd6713a770022a9b14330d2f86c))
* correct manifest decoding logic ([d6b42c6](https://github.com/ubq-testing/ubiquibot-kernel/commit/d6b42c6bbaa72954abe94072aece1cb4e3fd85a7))
* correct manifest decoding logic ([f76696b](https://github.com/ubq-testing/ubiquibot-kernel/commit/f76696ba635ace0d24e1c709da5bd34ee0251b6f))
* correct variable used in error logging ([37ca024](https://github.com/ubq-testing/ubiquibot-kernel/commit/37ca024c55cef96fa0624723e8c4f31891873518))
* disable husky on production ([e5c86f5](https://github.com/ubq-testing/ubiquibot-kernel/commit/e5c86f547e0159234885d66082632b5104800d50))
* empty store ([9eb1014](https://github.com/ubq-testing/ubiquibot-kernel/commit/9eb10143182c70873d7ed7c92c7659eaf3fb1ad9))
* enabled nodejs compat ([bc05c58](https://github.com/ubq-testing/ubiquibot-kernel/commit/bc05c5815161dfc78a825ef9367d55c56ce6e30c))
* enabled nodejs compat ([8b27baa](https://github.com/ubq-testing/ubiquibot-kernel/commit/8b27baa661b8162de23378ac2e9f684282dfff93))
* enabled nodejs compat ([41e4b96](https://github.com/ubq-testing/ubiquibot-kernel/commit/41e4b96a62555a0c83d033e9541fe4c5eb91615e))
* enhance error log context and config path handling ([1f91746](https://github.com/ubq-testing/ubiquibot-kernel/commit/1f91746f8ea29760fd190022a8d5f776cf300025))
* enhance error log context and config path handling ([9a4bede](https://github.com/ubq-testing/ubiquibot-kernel/commit/9a4beded34fda1226372bb901b262e3a072c7ee1))
* execution break ([e62393b](https://github.com/ubq-testing/ubiquibot-kernel/commit/e62393b97a0355b390581156972fe2c9afccd3fa))
* export Manifest type from SDK ([2b090cd](https://github.com/ubq-testing/ubiquibot-kernel/commit/2b090cd26d8be7938ca9f33f8152e05506ce143e))
* file name ([98fdee7](https://github.com/ubq-testing/ubiquibot-kernel/commit/98fdee7f84ec3ec4aa57ebdd990cf2172a694bb5))
* fixed failing worflows ([5477763](https://github.com/ubq-testing/ubiquibot-kernel/commit/54777634d3316fe35893114c40214e96b28d5265))
* fixed proxy target url ([aa3a2ac](https://github.com/ubq-testing/ubiquibot-kernel/commit/aa3a2acc1fa9521d90fdad71ade688e42958395d))
* fixed proxy target url ([7079aba](https://github.com/ubq-testing/ubiquibot-kernel/commit/7079abab83b8810c64761373adf4eeda118f5a67))
* illegal invocation ([ef41f58](https://github.com/ubq-testing/ubiquibot-kernel/commit/ef41f5896c6c324b446cfaa347630c4acad00e2c))
* illegal invocation ([f393668](https://github.com/ubq-testing/ubiquibot-kernel/commit/f39366866b29863b5d7772c1dd60fae45921dbfb))
* import buffer from node namespace ([bd9c210](https://github.com/ubq-testing/ubiquibot-kernel/commit/bd9c21053c4131121150a1fd1277d4e9fc57307e))
* imports ([01854e7](https://github.com/ubq-testing/ubiquibot-kernel/commit/01854e7d3e1a9ad824b6a34d13e7c2e77b276af4))
* improve manifest retrieval and ensure return value in collectLinkedIssue function ([28da818](https://github.com/ubq-testing/ubiquibot-kernel/commit/28da81868c75a915619a4c49519201152a9d9609))
* improved logs ([32996e5](https://github.com/ubq-testing/ubiquibot-kernel/commit/32996e55baeb8e0677322ade5d083d35532f4557))
* install @ubiquity-os/ubiquity-os-logger ([4d6eae9](https://github.com/ubq-testing/ubiquibot-kernel/commit/4d6eae95d0826a20c8f52ac9c991bc85eeb4c379))
* knip ([64681b8](https://github.com/ubq-testing/ubiquibot-kernel/commit/64681b8abcbabe63c2e8490c30730c5cff7cf694))
* knip ([5b3dfad](https://github.com/ubq-testing/ubiquibot-kernel/commit/5b3dfade96b21065664f35db972d9cdcbb2704ea))
* knip, test ([6018c59](https://github.com/ubq-testing/ubiquibot-kernel/commit/6018c596cea743d0e41457434fbda4a40df59ff2))
* lockfile updates ([7b0f60d](https://github.com/ubq-testing/ubiquibot-kernel/commit/7b0f60d775b91181ee76e5cdbc8346ce939d1564))
* lockfile updates ([74c4fb3](https://github.com/ubq-testing/ubiquibot-kernel/commit/74c4fb32997aadbc72b3a85395a713ad68beb013))
* log if comment can't be created ([ba98cb6](https://github.com/ubq-testing/ubiquibot-kernel/commit/ba98cb691e168b5d563ac45611cd10cc08216f93))
* manifest commands are properly checked for skipping ([b4e8fb6](https://github.com/ubq-testing/ubiquibot-kernel/commit/b4e8fb6642dd3a759583c1998b1a351b4f3f0e56))
* packages ([7277580](https://github.com/ubq-testing/ubiquibot-kernel/commit/7277580ae867ec22c01e73317d3ec4cffbfce325))
* pin version ([4cd4ae6](https://github.com/ubq-testing/ubiquibot-kernel/commit/4cd4ae6edf7aed0d8ffa13a93459ea0136794156))
* **push-event:** handle changes to both dev and prod config ([b927790](https://github.com/ubq-testing/ubiquibot-kernel/commit/b927790d50a8f42ae53f20e0f13304dc67dd2c30))
* **push-event:** handle changes to both dev and prod config ([9435e12](https://github.com/ubq-testing/ubiquibot-kernel/commit/9435e1222d7c5726f67c2e7e77df2c15aef7cd27))
* read manifest from branch ([51650d0](https://github.com/ubq-testing/ubiquibot-kernel/commit/51650d0e007a1880e8a751d1304f363cb88bb36a))
* regex to match action now accepts higher depth ([668062f](https://github.com/ubq-testing/ubiquibot-kernel/commit/668062fcee5d3aab60cc97ac7434f57b4efcbb35))
* remove broken test ([472e929](https://github.com/ubq-testing/ubiquibot-kernel/commit/472e929324319ee7d7282cb8fc960d63445ec737))
* remove SDK files and update dependencies ([e1ae93c](https://github.com/ubq-testing/ubiquibot-kernel/commit/e1ae93c1b7fc94036102dd65152e5e9d75238a90))
* remove SDK files and update dependencies ([d47c5f2](https://github.com/ubq-testing/ubiquibot-kernel/commit/d47c5f28c1a0c68ed9ecd0269d143a411b9ac979))
* remove test command ([fcb4078](https://github.com/ubq-testing/ubiquibot-kernel/commit/fcb4078241964c05c6b011bc44fa1415feb5c8b3))
* remove ubiquibot phrasing ([b22d978](https://github.com/ubq-testing/ubiquibot-kernel/commit/b22d97842415be571c1b210a61cf5b9dd0aea913))
* removed default value for `skipBotEvents` becoming true even when overridden in manifest.json ([d9ae748](https://github.com/ubq-testing/ubiquibot-kernel/commit/d9ae7482477dbe9d07c367ddb795f66250b97e69))
* replace process.env with ctx.env in server.ts ([be749c8](https://github.com/ubq-testing/ubiquibot-kernel/commit/be749c86614868d23e52cb6efbb0b7be80419dd2))
* replace process.env with ctx.env in server.ts ([d376750](https://github.com/ubq-testing/ubiquibot-kernel/commit/d376750105fbebe087a5f013c426002a58d8af65))
* resolve input decoding issue in server.ts ([fe99961](https://github.com/ubq-testing/ubiquibot-kernel/commit/fe99961d583a5ca683a98905de0b108471c4089a))
* **sdk:** add postComment function for structured metadata ([b87f4ca](https://github.com/ubq-testing/ubiquibot-kernel/commit/b87f4cad9106ae802ce6407dd58b2221264e8554))
* serialize plugin and value in error messages ([7841107](https://github.com/ubq-testing/ubiquibot-kernel/commit/78411073714163f0fddde09b3b3a16705705f955))
* simplify array check ([0421c30](https://github.com/ubq-testing/ubiquibot-kernel/commit/0421c306a0a67ceed8a9a0007b14d93a0649bc14))
* skip posting help comment when no commands found ([686761e](https://github.com/ubq-testing/ubiquibot-kernel/commit/686761e3f3877b8178c28a9c8249c17914514d75))
* skip posting help comment when no commands found ([a71eb67](https://github.com/ubq-testing/ubiquibot-kernel/commit/a71eb673678b4eb438dd4c6d78f17a78f40f4503))
* spell ([b40750f](https://github.com/ubq-testing/ubiquibot-kernel/commit/b40750ffa37ec668eb1dd0c2ee7fd0525c66f73f))
* streamline manifest command check in mapAuthorToBot function ([7ea1e06](https://github.com/ubq-testing/ubiquibot-kernel/commit/7ea1e06cebcf372f2b9d34670bca040ee04e0ac1))
* tests ([1fd1fbc](https://github.com/ubq-testing/ubiquibot-kernel/commit/1fd1fbc33a5982f4dd35877b5aa8a676e95719aa))
* tests ([b58f0f0](https://github.com/ubq-testing/ubiquibot-kernel/commit/b58f0f0bee7511993d32c2d8e4158852296048bd))
* tests ([164f247](https://github.com/ubq-testing/ubiquibot-kernel/commit/164f247f16868f99e133ec768d8d4c8d4ef6646b))
* tests ([e32602a](https://github.com/ubq-testing/ubiquibot-kernel/commit/e32602a1f357d093a2a7471796fbe54ae49176e5))
* tests ([7d6d1c0](https://github.com/ubq-testing/ubiquibot-kernel/commit/7d6d1c0b18ca5f2067e3b6737e22c30e03378a73))
* the default values for skipBotEvents and ubiquity:listeners is no longer overridden ([2d59a51](https://github.com/ubq-testing/ubiquibot-kernel/commit/2d59a51fcbbd91fb1ca30646dc1c18d197b9265b))
* the default values for skipBotEvents and ubiquity:listeners is no longer overridden ([144cc55](https://github.com/ubq-testing/ubiquibot-kernel/commit/144cc558c9d8328d893d094cf5ba05877f5d736a))
* the default values for skipBotEvents and ubiquity:listeners is no longer overridden ([127679f](https://github.com/ubq-testing/ubiquibot-kernel/commit/127679faf1da17f7c548487697c08a694172e199))
* trimming body to find commands ([fd17b58](https://github.com/ubq-testing/ubiquibot-kernel/commit/fd17b5814da8ca35812738a7a3bf06ab8bee18dd))
* tsup ([e0ccba3](https://github.com/ubq-testing/ubiquibot-kernel/commit/e0ccba36bc84febb11e00146aa2ea1c051e6fe0d))
* types ([bfe4651](https://github.com/ubq-testing/ubiquibot-kernel/commit/bfe46515a257ff6c41b97581d25f4c125046f60f))
* unified inputs for worker and action to generate the same payload and signature ([9fed981](https://github.com/ubq-testing/ubiquibot-kernel/commit/9fed981deb143ef8157137b4c276c2604ad2a9c8))
* unified inputs for worker and action to generate the same payload and signature ([bec803b](https://github.com/ubq-testing/ubiquibot-kernel/commit/bec803b8c9b899bc839b06355a955f835b78eb6e))
* unified inputs for worker and action to generate the same payload and signature ([d8ca283](https://github.com/ubq-testing/ubiquibot-kernel/commit/d8ca2833e4042c0d62858543ac5b959125a90fbf))
* update comment body to use diff instead of raw log ([1ccbac3](https://github.com/ubq-testing/ubiquibot-kernel/commit/1ccbac3ad3083f0527fc62290d00b0f0470ed86f))
* update dependencies in package.json ([f09bf82](https://github.com/ubq-testing/ubiquibot-kernel/commit/f09bf82088e19d853537d71189e4f0bbd0b409c3))
* update eslint ignores ([758145b](https://github.com/ubq-testing/ubiquibot-kernel/commit/758145bf998e66560ae105e0353b8a5ede05f19f))
* update Husky setup for production and CI ([9a76d37](https://github.com/ubq-testing/ubiquibot-kernel/commit/9a76d37ec6839f2296cece682192b9cb653b0553))
* update husky to version 9.1.6 ([ca08e9f](https://github.com/ubq-testing/ubiquibot-kernel/commit/ca08e9f8485a9ae8129e96fdefe052c1a9109ac0))
* update module paths and tsup config for modern output ([c517513](https://github.com/ubq-testing/ubiquibot-kernel/commit/c5175131d77f8647ecc8550aaa16c0a51d3e8e65))
* update module paths and tsup config for modern output ([3b1f303](https://github.com/ubq-testing/ubiquibot-kernel/commit/3b1f3036a3fdc672f3da357171949ae0508ec157))
* update package name in package.json ([c6e3ec2](https://github.com/ubq-testing/ubiquibot-kernel/commit/c6e3ec2dd7371b116b33bd208b07bd220c8d8b95))
* update package name in package.json ([a8ac6fb](https://github.com/ubq-testing/ubiquibot-kernel/commit/a8ac6fbdab86622dd40ed5382f79babd15f13565))
* update public key to match new private key ([e14bdef](https://github.com/ubq-testing/ubiquibot-kernel/commit/e14bdef68f3e14826fa6f45919ad7656ea4f8d3d))
* update public key to match new private key ([6986998](https://github.com/ubq-testing/ubiquibot-kernel/commit/69869988257fbf63ebe37c4c033ab75bc7d2d2ab))
* update release workflow for node support ([5e1239e](https://github.com/ubq-testing/ubiquibot-kernel/commit/5e1239e7622eaa9af8fbfe3a9ae925cd8cce0d70))
* update release-please.yml ([4fb79a0](https://github.com/ubq-testing/ubiquibot-kernel/commit/4fb79a0c736d5e23701084bd5d4fcd66b7e41f19))
* update sdk ([80e6bbc](https://github.com/ubq-testing/ubiquibot-kernel/commit/80e6bbcc5ff8823b733938180e4fea0a2addf4a2))
* update token variable and reorder dependencies ([f3c5df8](https://github.com/ubq-testing/ubiquibot-kernel/commit/f3c5df8b57e135c0e367c40cec19f8fea102bc28))
* worker deploy environment ([856f9a4](https://github.com/ubq-testing/ubiquibot-kernel/commit/856f9a44b411d0f109e94e28768f851f8ed2c38e))
* **worker:** handle exceptions properly in webhooks ([1792982](https://github.com/ubq-testing/ubiquibot-kernel/commit/17929825e807c57ed29eb84f7d59ba327ae06010))
* **worker:** handle exceptions properly in webhooks ([f146a64](https://github.com/ubq-testing/ubiquibot-kernel/commit/f146a64bff645023f1630c4aee4e5b7c649fc858))
* **workflow:** update worker-deploy and setup-kv scripts ([1c293d8](https://github.com/ubq-testing/ubiquibot-kernel/commit/1c293d8057bfe13282b7d8a6ec2998b43f6ae995))


### Miscellaneous Chores

* renamed kernel toml ([1c42c47](https://github.com/ubq-testing/ubiquibot-kernel/commit/1c42c47fd1f8916d71b90cd5cbff846e029e16ef))
